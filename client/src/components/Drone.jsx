...
const Drone = ({pilot}) => {
	...
	const ping = "absolute opacity-75 z-40 w-0 h-0 border-l-[8px] inline-flex border-r-[8px] border-b-[12px] border-l-transparent border-r-transparent border-b-green-400";
